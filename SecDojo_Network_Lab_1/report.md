...
### With that info, I sent the /etc/shadow file to my local machine and changed the root hash to be the same hash of the user that I already know the password of, and then I posted it back , so I can login to root
